...
function updateForMisses() {
    ...
    while (i < GameState.notes.length) {
        ...
        if (timePassedSinceNoteTime > 0.2 &&
            ...
            Render.drawNoteTimingEffects(GameState.NOTE_TIMINGS.MISS, null, GameState.notes[i].column);
        }
        ...
        while (i < GameState.notes.length) {
            ...
            if (currentNote.column === index && currentNote.hitY === -1) {
                ...
                if (noteTiming) {
                    ...
                    Render.drawNoteTimingEffects(noteTiming, currentNote.hitY, GameState.notes[i].column);
                    break;
                }
            }
            i++;
